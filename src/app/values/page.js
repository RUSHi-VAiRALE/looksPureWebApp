  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-28">
      ...
      <div className="space-y-6">
        <p>
          Founded in 2025, Lookspure was born from a simple but powerful idea: skincare should be <strong>HONEST</strong>, uncomplicated, and grounded in truth. We set out to challenge the norms of the beauty industry by championing clarity over confusion and facts over fear.
        </p>
